...
Variando los puntos a los que nos podemos acercar en cada iteración, la distancia a la que nos acercamos (no necesariamente <img src="https://latex.codecogs.com/svg.latex?\Large&space;1/2" /> ) y la probabilidad asignada para elegir el vértice, se obtienen diferentesfractales como el helecho de Barnsley que se muestra en la figura.
